...
/// Main Dashboard Screen displaying the TaskVassal UI.
class DashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: isDesktop ? null : Drawer(child: Sidebar(uid: user.uid)),
      body: SafeArea(
        child: Row(
          children: [
            // Left Sidebar (desktop only)
            if (isDesktop) Sidebar(uid: user.uid),
                      ...
                      builder: (context, settingsSnapshot) {
                        ...
                        return StreamBuilder<List<TaskModel>>(
                          ...
                          builder: (context, taskSnapshot) {
                            ...
                            final filteredTasks = appState.filterTasks(
                              allTasks,
                            );
